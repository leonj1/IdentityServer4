...
namespace IdentityServerHost.Configuration.Tests
{
    public class ResourcesTests
    {
        ...
        public void CustomProfile_ShouldHaveCorrectClaims()
        {
            ...
            Assert.Contains(JwtClaimTypes.Address, customProfile.UserClaims);
        }
        ...
        [Fact]
        public void Resource2_ShouldHaveCorrectUserClaims()
        {
        ...
        [Fact]
        public void ApiResources_ShouldHaveCorrectSecrets()
        {
            var resources = Resources.ApiResources.ToList();

            foreach (var resource in resources)
            {
                Assert.Single(resource.ApiSecrets);
                Assert.Equal("secret".Sha256(), resource.ApiSecrets.First().Value);
            }
        }
    }
}
